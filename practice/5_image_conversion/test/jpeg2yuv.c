...
//    char *inJpegName1 = "./test-image.jpg";
//    char *outRgbName1 = "./test-image.rgb24";
...
//    char *inJpegName3 = "./test-image.jpg";
...
//    sprintf(yuvFileName, "./test-image%s", yuvSuffix);
...
//    char *yuv420FileName = "./test-image.yuv420";
...
//
//    FILE *yuv2JpegOutFile = fopen("./yuv-to-jpeg.jpeg", "wb");
